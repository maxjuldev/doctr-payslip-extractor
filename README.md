...
[![License](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE) [![Python](https://img.shields.io/badge/Python-3.8+-green.svg)](https://python.org) [![Streamlit](https://img.shields.io/badge/Streamlit-Web%20App-red.svg)](https://streamlit.io) [![docTR](https://img.shields.io/badge/docTR-OCR%20Engine-orange.svg)](https://github.com/mindee/doctr)

**Extraction automatique de données de bulletins de paie française avec interface web**

Ce que vous pouvez attendre de ce repository:
...
- 👤 **Informations Employé**: Nom complet, adresse, n° sécurité sociale
...
├── demonstration_complete.py      # 🎯 Démonstration
